...
for line in lines:
    ...
    # NOTE : DEFINE_JUMP_LONG_VARIANT is only pairing metadata in HBC98; the
    # opcodes it names are defined by explicit DEFINE_OPCODE_ lines. Skip it so
    # it is not mistaken for a DEFINE_JUMP_n usage (which would crash/miscount).
